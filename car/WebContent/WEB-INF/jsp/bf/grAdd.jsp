            ...
            <div style="height: 500px;overflow: scroll;" class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" enctype="multipart/form-data" action="bf/grAddDo" class="form-horizontal">
                            <input type="hidden" name="fk_grCar_id" value="${gr.fk_grCar_id }">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" onchange="f2()" value="${cars_name }" style="float: left;width:400px;"  class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
                            <div class="form-group">
