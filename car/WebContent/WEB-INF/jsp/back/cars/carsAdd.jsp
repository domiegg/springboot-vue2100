            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" enctype="multipart/form-data" action="back/carsAddDo" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">车名</label>

                                <div class="col-sm-10">
                                    <input type="text" onchange="f2()" style="float: left;width:400px;" id="cars_name" name="cars_name" class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="cars_tel"  style="float: left;width:400px;" type="text" name="cars_price" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="ccomment" name="cars_message" class="form-control" required="" aria-required="true" style="margin: 0px -5.34375px 0px 0px; width: 319px; height: 103px;"></textarea>
                                </div>
                            </div>
