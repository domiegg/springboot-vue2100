...
<link href="back/artDialog/css/ui-dialog.css" rel="stylesheet"
    ...
    <script type="text/javascript">
        function contMdi(cont_id) {
            var d = top.dialog({
                title: '修改用户',
                url:'back/contLoad?cont_id='+cont_id,
                width:'600',
                height:'800',
                onclose:function(){
        ...
        function contDel(cont_id) {
            var d = top.dialog({
                title: '删除用户',
                url:'back/contDel?cont_id='+cont_id,
                width:'600',
                height:'800',
                onclose:function(){
                    window.location.reload();
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="ibox-tools">
                           <%-- <form target="_self" action="back/contList" >
                                <input type="text" value="${cont.cont_name }" placeholder="请输入用户名" name="cont_name" style="float: left;width:120px;" class="form-control">
                                <input type="text" value="${cont.cont_account }" placeholder="请输入账号" name="cont_account" style="float: left;width:120px;" class="form-control">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" name="cont_id" value="${cont.cont_id }" /></td>
                                    <td>${cont.client.client_name }</td>
                                    <td>${cont.client.client_account }</td>
                                    <td>${cont.client.client_tel }</td>
                                    <td>${cont.cont_message}</td>
                                    <td class="text-navy"> <input type="button" value="删除" onclick="contDel(${cont.cont_id})" class="btn btn-outline btn-danger"></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
