...
<link href="back/artDialog/css/ui-dialog.css" rel="stylesheet"
    ...
    <script type="text/javascript">
        function saysDel(says_id) {
            var d = top.dialog({
                title: '删除留言',
                url:'back/saysDel?says_id='+says_id,
                width:'600',
                height:'800',
                onclose:function(){
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" name="says_id" value="${says.says_id }" /></td>
                                    <td>${says.client.client_name }</td>
                                    <td>${says.says_message }</td>
                                    <td><fmt:formatDate value="${says.says_date }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                    <td class="text-navy"><input type="button" value="删除" onclick="saysDel(${says.says_id})" class="btn btn-outline btn-danger"></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
